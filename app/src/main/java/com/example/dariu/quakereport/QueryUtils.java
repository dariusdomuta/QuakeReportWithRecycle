...
public final class QueryUtils {
    ...
    private static URL createUrl(String stringUrl) {
        ...
        try{
            ...
            Log.e(LOG_TAG, "Problem buildin the URL ",e);
        }
        return url;
    }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try{
            ...
            if (inputStream != null) {
                //Closing the input stream clould throw an IOException, which is why
                //the makehttpRequest (URL url) method signature specifies than an IOExcep
                //could be thrown
                inputStream.close();
            }
        }
    ...
    public static List<Earthquake> fetchEarthquakeData (String requestURL) {
        ...
        //Perform HTTP request to the URL and receive a JSON response bacl
